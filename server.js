...
setInterval(()=>{ensureNetworkTests();refreshNetwork();renderNetworkTests();renderEdgeNetworkCards()},30000);setTimeout(()=>{ensureNetworkTests();renderEdgeNetworkCards()},1000);new MutationObserver(syncNetworkTheme).observe(document.documentElement,{attributes:true,attributeFilter:['data-theme']});</script></body></html>`;
